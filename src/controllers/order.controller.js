...
export const insertOrder = async (req, res) => {
    try {
        ...
        logger.error("controllers/order.controller.js:insertOrder - " + error.message);
...
export const getOrderById = async (req, res) => {
    try {
        ...
        logger.error("controllers/order.controller.js:getOrderById - " + error.message);
        return res.status(500).json({
            message: error.message,
            result: null,
        });
...
export const getAllOrder = async (req, res) => {
    ...
    try {
        ...
        logger.error("controllers/order.controller.js:getAllOrder - " + error.message);
        return res.status(500).json({
            message: error.message,
            result: null,
        });
...
export const generateExcel = async (req, res) => {
    ...
    try {
      ...
      WHERE o.date BETWEEN ${startDate} AND ${endDate}`;
        ...
        return res.status(200).json({
            message: "success generate excel",
...
export const orderYearly = async (req, res) => {
    ...
    `;
        ...
        return res.status(200).json({
            message: "success get yearly order",
            result: arry,
        });
    } catch (error) {
        logger.error("controllers/order.controller.js:orderYearly - " + error.message);
        return res.status(500).json({
            message: error.message,
            result: null,
        });
